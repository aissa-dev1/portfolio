...
export const experienceData2022: ExperienceCardData = {
  ...
  highlights: [
    ...
    "⚛️ First taste of React.js, and it was amazing!",
    "❤️ Fell in love with technology and TypeScript.",
  ],
};
...
export const experienceData2023: ExperienceCardData = {
  year: "2023",
  highlights: [
    "➡️ Carrying on the journey from 2022.",
...
export const experienceData2024: ExperienceCardData = {
  ...
  highlights: [
    ...
    "🛠️ Built Full Stack projects with Next.js and NestJS.",
